...
if __name__ == "__main__":
    # static_field(5., chargeList, ffunc='E')
    # static_field([-5., 5.,
    #               -5., 5.,
    #               -5., 5.],
    #              chargeList, nabla='grad', ffunc='phi')
    # static_field(5., current, ffunc='B')
    # static_field([-5., 5.,
    #               -5., 5.,
    #               -5., 5.], current, nabla='rot', ffunc='A', view='xy')

    static_field3d([-5., 5.,
                    -5., 5.,
                    -5., 5.], current, nabla='rot', ffunc='A')
    # static_field3d(5., chargeList, nabla='grad', ffunc='phi')

    # dynamic_field(2.0 * antenna.lambda_0, antenna.T, antenna, ffunc='E', save=False)
    # dynamic_field(2.0 * antenna.lambda_0, antenna.T, antenna, ffunc='H', save=False)
